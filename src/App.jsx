                  ...
                  <form onSubmit={handleSaveConnection} className="space-y-4">
                    <div className="form-group">
                      ...
                      <p className="text-[10px] text-slate-400 mt-1">
                        Deployment Web App URL generated by Apps Script (set to execute as "Me" and access "Anyone").
                      </p>
                    </div>
                    
                    <div className="form-group">
                      <label className="form-label">Google API Client ID (for Live OAuth)</label>
                      <input 
                        type="text" 
                        className="form-input font-mono text-xs" 
